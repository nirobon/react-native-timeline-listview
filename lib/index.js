...
let defaultCircleColor = '#4ca559'
let defaultLineWidth = 2
let defaultLineColor = '#4ca559'
let defaultTimeTextColor = '#4ca559'
let defaultDotColor = '#4ca559'
...
export default class Timeline extends Component {
  ...
  _renderEvent(rowData, sectionID, rowID){
    ...
    let lineColor = isLast?('#4ca559'):(rowData.lineColor?rowData.lineColor:this.props.lineColor)
    var opStyle = null
